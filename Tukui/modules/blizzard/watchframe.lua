...
TukuiWatchFrameAnchor.text = T.SetFontString(TukuiWatchFrameAnchor, C.media.pixelfont2, 14, "MONOCHROMEOUTLINE")
...
local function setup()	
	...
	WatchFrameCollapseExpandButton:FontString("text", C.media.pixelfont2, 14, "MONOCHROMEOUTLINE")
