...
C["media"] = {
	...
	["dmgfont"] = [[Fonts\\ARIALN.ttf]], -- general font of dmg / sct -- default [[Interface\AddOns\Tukui\medias\fonts\skurri.ttf]]
	...
	["flat"] = [[Interface\AddOns\Tukui\medias\textures\Flat]], -- unitframes combo points
